...
import { BookOpen, Code, Users, Bell, TrendingUp, Video, MonitorPlay, Sparkles } from "lucide-react";
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="container mx-auto px-4 pt-20 pb-12 flex-1">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
          ...
          <StatCard icon={MonitorPlay} label="Total Videos" value={totalVideos} delay={0.2} />
          <StatCard icon={BookOpen} label="Total Resources" value={totalResources + totalPlatforms} gradient delay={0.25} />
        </div>
